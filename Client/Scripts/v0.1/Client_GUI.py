...
class Home_Page(Page):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Home", pady=self.headerPadding, font=self.header)
        label.pack()
...
class Make_Transaction(Page):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Make a Transaction", pady=self.headerPadding, font=self.header)
        label.pack()

        label = tk.Label(self, text="Submit a Transaction below.", font=self.subheader)
        label.pack()

        formFrame = tk.Frame(self, pady=15)
        formFrame.pack()
...
class Wallet(Page):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Your Wallet", pady=self.headerPadding, font=self.header)
        label.pack()
        ...
        buttonFrame = tk.Frame(self, pady=15)
        buttonFrame.pack()
...
class View_Transactions(Page):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Past Transactions", font=self.header, pady=self.headerPadding)
        label.pack()
        ...
        self.data = [{"From":"Bob", "To":"Mike", "Amount":"5"},
        ...
        optionStyle.configure("BW.TLabel", width=20)
        ...
        self.optionsBar = ttk.OptionMenu(searchFrame, self.clicked,  "From", "From", "To", "Amount")
        self.optionsBar.pack(side=tk.LEFT)

        self.clicked.trace("w", lambda a, b, c:self.update_table())

        barFrame = tk.Frame(searchFrame, padx=20)
        barFrame.pack(side=tk.RIGHT)
            
        self.searchbar = tk.Entry(barFrame, width=40)
        self.searchbar.pack()
        self.searchbar.bind('<KeyRelease>', lambda key:self.update_table())
