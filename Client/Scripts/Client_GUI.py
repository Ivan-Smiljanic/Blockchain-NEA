...
class Client_GUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ordered_keys = (Home_Page, Make_Transaction, Wallet)
...
class Make_Transaction(Page):
    ...
    def generate_transaction(self):
        ...
        self.amountEntry.delete(0,len(amount))
...
class Wallet(Page):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Don't have a wallet? Click below to generate.", pady=20)
        label.pack()
